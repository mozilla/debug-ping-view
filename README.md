...
#### Data Collection
This project uses [Glean.js SDK](https://github.com/mozilla/glean.js) for telemetry data collection. If you want to disable data collection, please [turn on browser's Do Not Track](https://support.mozilla.org/en-US/kb/how-do-i-turn-do-not-track-feature) feature.
